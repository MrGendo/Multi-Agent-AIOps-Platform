...
class PlanExecuteState(TypedDict, total=False):
    ...
    response: str
    expert_reports: Annotated[List[str], operator.add]     # 主图使用: 各专家的结论合并
    iteration: int
    permission_mode: str
    ...
    # ===== Critic (Phase 5) =====
    critic_passed: bool                                    # 评审是否通过
    critic_feedback: str                                   # 驳回意见
    ...
    # ===== Remediation & HITL =====
    remediation_plan: str                                  # 提议的自愈修复步骤
    remediation_approved: bool                             # 人类是否已授权自愈操作
